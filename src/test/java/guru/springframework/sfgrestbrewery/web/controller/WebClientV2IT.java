...
public class WebClientV2IT {
    ...
    void getBeerById() throws InterruptedException {
        ...
        beerDtoMono.subscribe(beer -> {
            ...
            log.info("Found beer by id {}: {}", 1, beer.getBeerName());
    ...
    void getBeerByUpc() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL_UPC + "/" + beerUpc)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
        ...
        beerDtoMono.subscribe(beer -> {
            ...
            log.info("Found beer by upc {}: {}", beerUpc, beer.getBeerName());
